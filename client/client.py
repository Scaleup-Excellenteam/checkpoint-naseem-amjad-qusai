...
# Default host/port are the team values from main (commit 297b891).
# Override locally without editing this file:
#   CHAT_SERVER_IP=127.0.0.1 python client/client.py
